...
```{r rclogo, echo = FALSE, out.width=100, fig.align ='right'}
...
.bg-washed-green.b--dark-green.ba.bw2.br3.shadow-5.ph4.mt5[
`rrtools` proporciona instrucciones, plantillas y funciones para hacer un compendio básico adecuado para escribir **investigaciones reproducibles con R**.]
...
La **unidad fundamental de código** que se puede compartir en R, es el paquete.
...
knitr::include_url("https://media.springernature.com/full/springer-static/image/art%3A10.3758%2Fs13428-020-01436-x/MediaObjects/13428_2020_1436_Fig2_HTML.png?as=webp")
```
.footnote[[Vourre *et al.*(2020)](https://link.springer.com/article/10.3758/s13428-020-01436-x)]
---
...
# Agregar los paquetes a la DESCRIPACION
rrtools::add_dependencies_to_description()
```

Nota: Seguir el tutorial 
...
* Vuorre, M., Crump, M.J.C. [Sharing and organizing research products as R packages.](https://link.springer.com/article/10.3758/s13428-020-01436-x) Behav Res (2020). https://doi.org/10.3758/s13428-020-01436-x
