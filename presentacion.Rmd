...
meta() %>%
  ...
  meta_social(
    ...
    image = "https://res.cloudinary.com/flor/image/upload/v1608248795/hornoacal_jrb5mu.jpg",
    image_alt = paste(
...
### ¡Gracias R-Ladies Jujuy por la invitación!
...
```{r data-datum, echo = FALSE}
xaringanExtra::embed_xaringan("https://twitter.com/data_datum/status/1338926940443521031?s=19")
```
